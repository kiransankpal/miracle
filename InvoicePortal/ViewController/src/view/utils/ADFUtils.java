...
public class ADFUtils {
    ...
    /**
     * Finds Iterator.
     * @param bindingContainer the bindingContainer
     * @param iterator the iterator
     * @return returns IteratorBinding
     */
    ...
    /**
     * Finds Control Value Binding.
     * @param name the name
     * @return the Control Value Binding
     */
    ...
    /**
     * Prints the operation binding exceptions.
     * @param opList list of operation binding
     */
    ...
    /**
     * Execute operation binding and handle errors.
     * @param methodAction Method Action
